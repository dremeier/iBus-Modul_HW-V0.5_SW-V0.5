...
// Timing
#define SARA_R5_STANDARD_RESPONSE_TIMEOUT 300  // 1000
...
{
public:
  //void parseMQTTMessage(const String& response);
  // Constructor
...
#endif
  bool begin(HardwareSerial &hardSerial, unsigned long baud = 115200);
  //bool begin(HardwareSerial &hardSerial, unsigned long baud = 115200, int rtsPin, int ctsPin);
